    ...
    onRequestButtonClicked(e){
        ...
        Misc.getCurrentAccount(this.props.web3, (error, account) => {
            if (error){
                ...
                MachineContract.methods["getNewReading"](readingType).send({
                    from:account,
                        ...
                        <Card.Body>
                            <Form.Group label="Reading Type">
                                <Form.SelectGroup onChange={this.handleChange.bind(this)}>
                                    <Form.SelectGroupItem name="size" label="Temperature" value="0"/>
                                    <Form.SelectGroupItem name="size" label="Humidity" value="1" />
                                    <Form.SelectGroupItem name="size" label="Air Pressure" value="2" />
                                    <Form.SelectGroupItem name="size" label="Gas Resistance" value="3" />
                                    <Form.SelectGroupItem name="size" label="Brightness" value="4" />
                                </Form.SelectGroup>
                            </Form.Group>
                        </Card.Body>
                        <Card.Footer>
