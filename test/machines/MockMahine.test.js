...
describe("Machine", function () {
    const [ MachineOwner, machineID, product, anyone, Manufacturer, Maintainer, ProductContractAddress ] = accounts;

    beforeEach(async function () {
        this.MockMachineContract = await MockMachineArtifact.new(MachineOwner, machineID, ProductContractAddress, {from: MachineOwner});
