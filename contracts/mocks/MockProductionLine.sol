...
contract MockProductionLine is ProductionLine{
    ...
    event exeDummyTask(address indexed task, address indexed machine, string paramter);

    constructor() public {
        super.addTaskType(DUMMY_TASK_TYPE, "Dummy Task");
    }

    function assignDummyTask(address machine) public {
        super.assignTaskType(DUMMY_TASK_TYPE, machine);
    }
